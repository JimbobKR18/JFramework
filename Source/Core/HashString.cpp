...
void HashString::SerializeLUA()
{
  SLB::Class<HashString>("HashString")
    ...
    .set("Trim", &HashString::Trim)
    .set("Split", &HashString::Split)
    .set("Reverse", &HashString::Reverse)
    .set("Push", &HashString::Push)
    .set("Clear", &HashString::Clear)
    .set("EqualsCharArray", static_cast<bool(HashString::*)(char const*)const>(&HashString::operator==))
    .set("EqualsString", static_cast<bool(HashString::*)(std::string const&)const>(&HashString::operator==))
    .set("EqualsHashString", static_cast<bool(HashString::*)(HashString const&)const>(&HashString::operator==))
