...
$(IntermediateDirectory)/Core_FileCache.cpp$(ObjectSuffix): ../../Source/Core/FileCache.cpp $(IntermediateDirectory)/Core_FileCache.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jimmy/Documents/JFramework/Source/Core/FileCache.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Core_FileCache.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Core_FileCache.cpp$(DependSuffix): ../../Source/Core/FileCache.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Core_FileCache.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/Core_FileCache.cpp$(DependSuffix) -MM "../../Source/Core/FileCache.cpp"

$(IntermediateDirectory)/Core_FileCache.cpp$(PreprocessSuffix): ../../Source/Core/FileCache.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Core_FileCache.cpp$(PreprocessSuffix) "../../Source/Core/FileCache.cpp"
...
$(IntermediateDirectory)/Graphics_SurfaceProperty.cpp$(ObjectSuffix): ../../Source/Graphics/SurfaceProperty.cpp $(IntermediateDirectory)/Graphics_SurfaceProperty.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jimmy/Documents/JFramework/Source/Graphics/SurfaceProperty.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Graphics_SurfaceProperty.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Graphics_SurfaceProperty.cpp$(DependSuffix): ../../Source/Graphics/SurfaceProperty.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Graphics_SurfaceProperty.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/Graphics_SurfaceProperty.cpp$(DependSuffix) -MM "../../Source/Graphics/SurfaceProperty.cpp"

$(IntermediateDirectory)/Graphics_SurfaceProperty.cpp$(PreprocessSuffix): ../../Source/Graphics/SurfaceProperty.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Graphics_SurfaceProperty.cpp$(PreprocessSuffix) "../../Source/Graphics/SurfaceProperty.cpp"
...
$(IntermediateDirectory)/Logic_SystemProperties.cpp$(ObjectSuffix): ../../Source/Logic/SystemProperties.cpp $(IntermediateDirectory)/Logic_SystemProperties.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jimmy/Documents/JFramework/Source/Logic/SystemProperties.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Logic_SystemProperties.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Logic_SystemProperties.cpp$(DependSuffix): ../../Source/Logic/SystemProperties.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Logic_SystemProperties.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/Logic_SystemProperties.cpp$(DependSuffix) -MM "../../Source/Logic/SystemProperties.cpp"

$(IntermediateDirectory)/Logic_SystemProperties.cpp$(PreprocessSuffix): ../../Source/Logic/SystemProperties.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Logic_SystemProperties.cpp$(PreprocessSuffix) "../../Source/Logic/SystemProperties.cpp"
...
$(IntermediateDirectory)/Managers_NetworkManager.cpp$(ObjectSuffix): ../../Source/Managers/NetworkManager.cpp $(IntermediateDirectory)/Managers_NetworkManager.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jimmy/Documents/JFramework/Source/Managers/NetworkManager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Managers_NetworkManager.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Managers_NetworkManager.cpp$(DependSuffix): ../../Source/Managers/NetworkManager.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Managers_NetworkManager.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/Managers_NetworkManager.cpp$(DependSuffix) -MM "../../Source/Managers/NetworkManager.cpp"

$(IntermediateDirectory)/Managers_NetworkManager.cpp$(PreprocessSuffix): ../../Source/Managers/NetworkManager.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Managers_NetworkManager.cpp$(PreprocessSuffix) "../../Source/Managers/NetworkManager.cpp"
...
$(IntermediateDirectory)/Network_PCNetworkPort.cpp$(ObjectSuffix): ../../Source/Network/PCNetworkPort.cpp $(IntermediateDirectory)/Network_PCNetworkPort.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jimmy/Documents/JFramework/Source/Network/PCNetworkPort.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Network_PCNetworkPort.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Network_PCNetworkPort.cpp$(DependSuffix): ../../Source/Network/PCNetworkPort.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Network_PCNetworkPort.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/Network_PCNetworkPort.cpp$(DependSuffix) -MM "../../Source/Network/PCNetworkPort.cpp"

$(IntermediateDirectory)/Network_PCNetworkPort.cpp$(PreprocessSuffix): ../../Source/Network/PCNetworkPort.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Network_PCNetworkPort.cpp$(PreprocessSuffix) "../../Source/Network/PCNetworkPort.cpp"

$(IntermediateDirectory)/Network_NetworkPort.cpp$(ObjectSuffix): ../../Source/Network/NetworkPort.cpp $(IntermediateDirectory)/Network_NetworkPort.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jimmy/Documents/JFramework/Source/Network/NetworkPort.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Network_NetworkPort.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Network_NetworkPort.cpp$(DependSuffix): ../../Source/Network/NetworkPort.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Network_NetworkPort.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/Network_NetworkPort.cpp$(DependSuffix) -MM "../../Source/Network/NetworkPort.cpp"
